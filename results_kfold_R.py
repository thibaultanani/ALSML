...
if __name__ == '__main__':
    train_df, test_df = read(filename="new_als_R_train"), read(filename="new_als_R_test")
    target_feature = "Survived"
    removal = ['ID', 'ExID', 'Period', 'Subject ID', 'Source', 'Death Date', 'Survival', 'ALSFRSR T3', 'ALSFRSR T6',
    ...
    features_corr = ['Gender', 'Age', 'Weight', 'Height', 'Onset', 'Q1 Speech', 'Q2 Salivation', 'Q3 Swallowing',
                     ...
                     'ALSFRSR', 'R 1 Dyspnea', 'R 2 Orthopnea', 'R 3 Respiratory Insufficiency', 'bmi', 'bulbar score',
                     'upper limbs score', 'trunk score', 'lower limbs score', 'respiratory score', 'mitos movement',
                     ...
                     'ft9 gross motor', 'ft9 respiratory']
    fitness(train=train_df, subset=features_corr, target=target_feature, models=scikit_models, metric=scoring_metric,
            standardisation=std, k=fold_number)

    print("\nanova:")
    features_anova = ['Gender', 'Age', 'Weight', 'Q1 Speech', 'Q2 Salivation', 'Q3 Swallowing', 'Q4 Handwriting',
                      'Q5 Cutting', 'Q6 Dressing and Hygiene', 'Q7 Turning in Bed', 'Q8 Walking', 'Q9 Climbing Stairs',
                      'Q10 Respiratory', 'ALSFRS', 'Symptom Duration', 'Forced Vital Capacity', 'Pulse', 'ALSFRSR',
                      'R 1 Dyspnea', 'R 2 Orthopnea', 'R 3 Respiratory Insufficiency', 'bmi', 'bulbar score',
                      'upper limbs score', 'trunk score', 'lower limbs score', 'respiratory score', 'mitos movement',
                      'mitos swallowing', 'mitos communicating', 'mitos total', 'kings bulbar', 'kings arm',
    ...
    print("\nmutual info:")
    features_mi = ['Gender', 'Age', 'Weight', 'Height', 'Onset', 'Q1 Speech', 'Q2 Salivation', 'Q3 Swallowing',
                   'Q4 Handwriting', 'Q5 Cutting', 'Q5 Indic', 'Q6 Dressing and Hygiene', 'Q7 Turning in Bed',
                   'Q8 Walking', 'Q9 Climbing Stairs', 'Q10 Respiratory', 'ALSFRS', 'Symptom Duration',
                   'Forced Vital Capacity', 'Pulse', 'Diastolic Blood Pressure', 'Systolic Blood Pressure', 'ALSFRSR',
                   'trunk score', 'lower limbs score', 'respiratory score', 'mitos movement', 'mitos swallowing',
                   'mitos communicating', 'mitos total', 'kings arm', 'kings leg', 'kings niv', 'kings total',
                   'ft9 bulbar', 'ft9 gross motor', 'ft9 respiratory', 'ft9 total', 'decline rate']
    ...
    features_relief = ['Gender', 'Age', 'Weight', 'Height', 'Onset', 'Q1 Speech', 'Q2 Salivation', 'Q3 Swallowing',
                       'Q4 Handwriting', 'Q5 Cutting', 'Q5 Indic', 'Q6 Dressing and Hygiene', 'Q7 Turning in Bed',
                       'Q8 Walking', 'Q9 Climbing Stairs', 'Q10 Respiratory', 'ALSFRS', 'Symptom Duration',
                       'Forced Vital Capacity', 'Pulse', 'ALSFRSR', 'R 1 Dyspnea', 'R 2 Orthopnea', 'bulbar score',
                       'upper limbs score', 'trunk score', 'lower limbs score', 'respiratory score', 'mitos movement',
                       'mitos communicating', 'mitos breathing', 'mitos total', 'kings bulbar', 'kings arm',
                       'kings leg', 'kings niv', 'kings total', 'ft9 bulbar', 'ft9 fine motor', 'ft9 gross motor',
    ...
    features_de = ['Gender', 'Age', 'Height', 'Q1 Speech', 'Q2 Salivation', 'Q5 Indic', 'Q7 Turning in Bed',
